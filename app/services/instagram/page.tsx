// app/services/instagram/page.tsx
...
export const metadata: Metadata = {
  title: "Instagramのトラブル解決",
  description:
    "Instagramが読み込めない・表示されない・ログインできない時に、障害か自分側かを確認し、最短で対処します。",
  alternates: { canonical: "/services/instagram" }
};
    ...
    <main className="mx-auto max-w-3xl px-4 py-10 text-slate-900">
      <header className="space-y-3">
        ...
        <p className="text-base text-neutral-600">
          Instagramが読み込めない、フィードが表示されない、ログインできない時は、まず「障害か自分側か」を確認するのが最短です。
          下のガイドから始めてください。
        </p>
      </header>

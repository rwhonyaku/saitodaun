...
export const metadata: Metadata = {
  ...
  description:
    "YouTube、LINE、X、Amazon、PayPay、楽天、Yahoo! JAPAN、TikTok、Zoomなど、サービスが使えない時に「障害か自分側か」を最短で切り分けて対処するガイド集です。",
};
    ...
    <main className="mx-auto max-w-3xl px-4 py-10">
      <header className="space-y-3">
        ...
        <p className="text-base text-neutral-600">
          「サービス側の障害」か「自分の環境（回線/端末/ブラウザ/DNS）」かを短時間で切り分け、最短の対処に誘導します。
          まずは該当サービスを選んでください。
        </p>
      </header>

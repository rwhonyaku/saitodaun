// app/services/outlook/not-working/page.tsx
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 text-slate-900">
      <header className="space-y-3">
        ...
        <div className="rounded-2xl border border-neutral-200 p-5">
          ...
          <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-neutral-700">
            ...
            <li>
              Outlookだけだめなら、ブラウザ、アプリ、ログイン状態、同期設定の問題が多いです。
            </li>
          </ol>
        </div>
      </header>
      ...
      <section className="mt-10 space-y-3">
        <h2 className="text-xl font-semibold">1) 今、Outlookは障害？</h2>
      ...
      <section className="mt-10 space-y-3">
        ...
        <div className="space-y-3">
          <div className="rounded-2xl border border-neutral-200 p-6">
            ...
            <p className="mt-2 text-sm text-neutral-700">
              Outlookが開かない、ログインできない、メール同期が遅い、送受信が不安定などは、Microsoft側の障害でも起きます。
          ...
          <div className="rounded-2xl border border-neutral-200 p-6">
            ...
            <p className="mt-2 text-sm text-neutral-700">
              Outlookだけ不安定に見えても、DNS解決、通信経路、VPN、プロキシの影響で起きることがあります。
          ...
          <div className="rounded-2xl border border-neutral-200 p-6">
            <h3 className="text-base font-semibold">アカウントや同期設定の問題</h3>
            <p className="mt-2 text-sm text-neutral-700">
              パスワード変更後の再認証、アカウント同期不良、アプリ設定の不整合などでも、メール送受信が止まることがあります。
              特に「開けるが送れない」「受信だけ遅い」「アプリだけ不安定」といった症状は、この方向を疑いやすいです。
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-10 space-y-3">
        ...
        <ol className="list-decimal space-y-2 pl-5 text-sm text-neutral-700">
          ...
          <li>OutlookやMicrosoft関連のサイトデータ（Cookie、キャッシュ）を削除して再ログインする。</li>
        ...
        <div className="rounded-2xl border border-neutral-200 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-neutral-700">
            ...
            <li>アプリの同期設定や再認証不足で受信が止まることがあります。</li>
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm text-neutral-700">
          ...
          Outlook自体の問題に見えても、実際は通信やブラウザ側の症状であることがあります。
        </p>

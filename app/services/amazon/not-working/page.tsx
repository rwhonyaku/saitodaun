// app/services/amazon/not-working/page.tsx
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      <header className="space-y-3">
        ...
        <div className="rounded-2xl border border-neutral-200 p-5">
          ...
          <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-neutral-700">
            ...
            <li>
              Amazonだけだめなら、ブラウザ、アプリ、端末、アカウント周りが原因のことが多いです。
            </li>
          </ol>
        </div>
      </header>
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm text-neutral-700">
          まずここから確認してください。障害中にキャッシュ削除や再インストールを何度やっても改善しないことは珍しくありません。
      ...
      <section className="mt-10 space-y-3">
        ...
        <div className="rounded-2xl border border-neutral-200 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-neutral-700">
            ...
            <li>
              <b>別端末</b>で試す。どの端末でも同じなら障害や回線、端末ごとに違うならアプリやブラウザ側が濃厚です。
            </li>
            <li>
              <b>シークレットモードや別ブラウザ</b>で試す。動くなら、拡張機能、Cookie、キャッシュが原因のことが多いです。
            </li>
          </ul>
      ...
      <section className="mt-10 space-y-3">
        ...
        <div className="space-y-3">
          <div className="rounded-2xl border border-neutral-200 p-6">
            <h3 className="text-base font-semibold">Amazon側の障害</h3>
            <p className="mt-2 text-sm text-neutral-700">
              サイトが重い、ログインが不安定、カートや決済が途中で止まるといった症状は、Amazon側の障害でも起きます。
              この場合は利用者側で大きく触っても改善しにくいため、まずは状況確認が先です。
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 p-6">
            ...
            <p className="mt-2 text-sm text-neutral-700">
              Amazonだけ不安定に見えても、DNS解決、通信経路、VPN、プロキシの影響で起きることがあります。
              特にWi-Fiではだめでモバイル通信では開く場合は、この方向を先に疑う方が効率的です。
            </p>
      ...
      <section className="mt-10 space-y-3">
        ...
        <div className="rounded-2xl border border-neutral-200 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-neutral-700">
            <li>シークレットモードでログインを試して、Cookieの影響を除外する。</li>
            <li>別回線で試して、回線やDNSの問題を除外する。</li>
            <li>別端末（スマホやPC）で試して、端末やアプリ起因を除外する。</li>
          </ul>
        </div>

        <div className="rounded-2xl border border-neutral-200 p-6">
          <h3 className="text-base font-semibold">購入できない・決済が進まない場合（追加チェック）</h3>
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-neutral-700">
            <li>一度カートを空にして、商品を入れ直す。</li>
            <li>別ブラウザや別端末で試して、セッションや拡張機能の影響を除外する。</li>
            <li>回線を変えて試して、時間帯や経路の差を確認する。</li>
            <li>障害の可能性が高いときは、無理に操作を繰り返さず少し待つ。</li>
          </ul>
        </div>
      </section>
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm text-neutral-700">
          ...
          Amazonそのものの問題に見えても、実際は通信やブラウザ側の症状であることがあります。
        </p>

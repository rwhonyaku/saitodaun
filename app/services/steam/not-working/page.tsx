...
export const metadata: Metadata = {
  ...
  description:
    "Steamが使えない・開かない時に、ログインできない・接続できない・重い症状を短く切り分けるためのページです。",
};
    ...
    <main className="mx-auto max-w-3xl px-4 py-10">
      <header className="space-y-3">
        ...
        <p className="text-base text-neutral-600">
          Steamで使えない症状が出るときは、全体障害か、自分の接続や端末側かを先に切り分けます。
        </p>
        ...
        <p className="text-sm text-neutral-700">
          ログインできない・接続できない・重いなどの症状別に確認できます。
        </p>
      </header>
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm text-neutral-700">
          サーバー障害でなければ、認証画面の失敗、アカウント確認、端末側の時刻ずれを先に見ます。
        </p>
      </section>
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm text-neutral-700">
          ストアやログインはできても極端に重いときは、広い側の混雑か、地域的な接続遅延かを切り分けます。
        </p>
      </section>
    </main>
  );

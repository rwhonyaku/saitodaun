    ...
    <main className="mx-auto max-w-3xl px-4 py-10 text-slate-900">
      <header className="space-y-3">
        ...
        <p className="text-base text-neutral-600">
          まず広いNetflix障害の兆候を確認し、その後で接続、再生開始、バッファリング、作品・端末固有のどこに問題があるかを切り分けます。
        </p>
      </header>
      ...
      <div className="mt-6">
        <ServiceStatusBridge
          ...
          advice={{
            likely:
              "Netflix側の広い問題が疑われます。アプリの再インストール、ログアウト、テレビやネットワーク設定の初期化は急がず、最も多い症状と公式サービス状況を確認してください。急ぎの場合は別の対応端末や、正常に動く別の動画サービスを利用します。",
            partial:
            ...
            unknown:
              "自動確認だけでは判断できません。Netflixの詳しい状況と公式サービス状況を確認し、広い障害が見つからなければ下の症状別確認へ進んでください。",
          }}
        />
      </div>

// app/services/google/not-working/page.tsx
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/services/google/not-working" }
};
    ...
    <main className="mx-auto max-w-3xl px-4 py-10 text-slate-900">
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-semibold tracking-tight">
          Googleが開けない・検索できない？（障害か自分側かを最短判定）
        </h1>
        ...
        <div className="rounded-2xl border border-neutral-200 p-5">
          ...
          <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-neutral-700">
            ...
            <li>
              Googleだけだめなら、ブラウザ、拡張機能、VPN、端末側の問題が多いです。
            </li>
          </ol>
        </div>
      </header>
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm text-neutral-700">
          まずここから確認します。Google側で障害が起きているときは、ブラウザや端末をいろいろ触っても改善しないことが多いです。
      ...
      <section className="mt-10 space-y-3">
        ...
        <div className="rounded-2xl border border-neutral-200 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-neutral-700">
            ...
            <li>
              <b>シークレットモードや別ブラウザ</b>で試す。動くなら、Cookie、キャッシュ、拡張機能が原因のことが多いです。
            </li>
            <li>
              <b>VPNやプロキシをOFF</b>にする。企業ネットワークや一部VPNではアクセスが不安定になることがあります。
            </li>
          </ul>
        ...
        <div className="space-y-3">
          <div className="rounded-2xl border border-neutral-200 p-6">
            ...
            <p className="mt-2 text-sm text-neutral-700">
              検索結果が出ない、アクセスが不安定、関連サービスが遅いといった症状は、Google側の障害でも起きます。
          ...
          <div className="rounded-2xl border border-neutral-200 p-6">
            ...
            <p className="mt-2 text-sm text-neutral-700">
              回線を切り替えると改善する場合は、DNS、通信経路、ルーター、VPNの影響が濃厚です。
              特にWi-Fiではだめでモバイル通信では使えるなら、この方向を先に疑う方が効率的です。
            </p>
          ...
          <div className="rounded-2xl border border-neutral-200 p-6">
            <h3 className="text-base font-semibold">ブラウザ状態（拡張機能・キャッシュ）</h3>
            <p className="mt-2 text-sm text-neutral-700">
              広告ブロックやスクリプト制御系の拡張機能、壊れたキャッシュ、Cookieの不整合で表示が止まることがあります。
              Googleだけ開けないときは、まずブラウザ側を疑う価値があります。
            </p>
            <div className="mt-3 flex flex-wrap gap-3">
              <Link className="text-sm underline" href="/troubleshooting/browser-not-loading-sites">
                ブラウザ側の原因を確認する
      ...
      <section className="mt-10 space-y-3">
        ...
        <ol className="list-decimal space-y-2 pl-5 text-sm text-neutral-700">
          <li>ページを更新し、必要ならブラウザを完全終了して再起動する。</li>
          <li>Wi-Fi ↔ モバイル通信に切り替える。</li>
          <li>VPNやプロキシを一時的にOFFにする。</li>
          <li>シークレットモードや別ブラウザで試す。</li>
          <li>google.com のサイトデータ（Cookie、キャッシュ）を削除する。</li>
      ...
      <section className="mt-10 space-y-3">
        ...
        <p className="text-sm text-neutral-700">
          ...
          Google自体の問題に見えても、実際は通信やブラウザ側の症状であることがあります。
        </p>
      ...
      <section className="mt-10 space-y-3">
        ...
        <div className="space-y-3">
          <div className="rounded-2xl border border-neutral-200 p-5">
            ...
            <p className="mt-2 text-sm text-neutral-700">
              ステータス確認をしたうえで、回線やブラウザを変えても状況がほぼ変わらないなら、障害の可能性が高いです。
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-neutral-200 p-5">
            ...
            <p className="mt-2 text-sm text-neutral-700">
              障害確認をする前の大きな設定変更や再インストールは避けた方が安全です。原因が回線やDNSなら直らないうえ、後で元に戻す手間が増えます。
            </p>
          </div>
        </div>
      </section>

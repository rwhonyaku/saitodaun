  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 text-sm leading-relaxed text-slate-800">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          {SITE.name}
          は、インターネット利用者が直面する「つながらない」という不安を確認するための接続確認サイトです。急なサービス停止やアクセス不能が起きた際に、それがサービス側の障害なのか、利用者自身の環境要因なのかを見分けるための参考情報を提供します。
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          本サイトは、状況確認と初期確認を素早く行うための参考ツールです。正式な稼働状況や障害情報は、各サービスの公式案内もあわせてご確認ください。
        </p>
      </section>

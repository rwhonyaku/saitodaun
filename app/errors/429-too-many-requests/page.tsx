  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "サイトが落ちているわけではなく、セキュリティや負荷対策として“意図的に抑制”されているケースがほとんどです。まずは“待つ”と“回線/IPを変える”で確認するのが最短です。",
      ]}
      sections={[
        {
          type: "list",
...

        {
          ...
          items: [
            ...
            "5) 自動アクセス系の拡張機能・アプリを一時停止（原因の確認）",
            "6) ログインが関係しそうなら、一度ログアウト→再ログイン（セッション不整合の確認）",
          ],
        },

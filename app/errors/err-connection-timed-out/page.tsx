...
export const metadata = {
  ...
  description:
    "ERR_CONNECTION_TIMED_OUT の意味、タイムアウトの典型原因（サイト側過負荷/回線/遮断/DNS）、ユーザー側でできる切り分け、運営者側の改善ポイントを解説します。",
};
  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "サイト側の遅延・停止だけでなく、回線や途中の遮断でも起こります。まずは“自分だけ”か“サイト全体”かを切り分けるのが最短です。",
      ]}
      sections={[
        {
          type: "list",

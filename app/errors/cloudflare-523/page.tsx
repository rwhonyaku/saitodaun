...
export const metadata = {
  ...
  description:
    "Cloudflare 523（Origin is unreachable）の意味、オリジンサーバーへ到達できない主な原因、DNSや経路設定ミスとの関係、ユーザー側と運営側の切り分け方を実用的に解説します。",
};
    ...
    <EvergreenPageShell
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            "Cloudflare 系の 52x は似て見えますが、失敗箇所が少しずつ違います。523 はオリジンへ到達できない、521 は到達したが拒否された、522 は接続確立が間に合わない、524 は接続後の応答完了が遅すぎる、という切り分けです。",
            <>
              近いページとして{" "}
              <Link
        ...
        },
        {
          ...
          body: [
            "523 はサイト側設定や到達経路の問題であることが多く、利用者側で直接直せることは多くありません。別回線で比べる、時間を置く、公式障害情報を確認する、といった切り分けが中心になります。",
            <>
              特定サービスで起きているなら{" "}
              <Link
                href="/services"
        ...
        },
        {
          ...
          items: [
            ...
            "Q. 自分だけ起きることはありますか？ → 可能性は低めですが、まず別回線で比較すると切り分けやすいです。",

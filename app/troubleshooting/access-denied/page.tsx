...
export const metadata: Metadata = {
  title: "「アクセスが拒否されました」と出るときの切り分け",
  description:
    "Access denied と出るときの切り分けページです。403、429、ファイアウォール、VPN や共有 IP の制限、確認ループ、特定サイトだけの制御など、次に見るべき既存ページへ案内します。",
  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "このページは、そうした broad な拒否系メッセージを最短で切り分けるための橋渡しページです。コード表示があるか、回線差があるか、確認ループなのか、特定サイトだけなのかを分けて、必要な既存ページへ進んでください。",
      ]}
      sections={[
        {
          type: "list",
        ...
        },
        {
          ...
          body: [
            "この wording は、サーバー停止や DNS 不達より、接続自体は届いているが条件に合わず拒否されているときに出やすいです。だから『サイトが落ちた』と考えるより、何の条件で止められているかを先に分けるほうが速くなります。",
            <>
              コードが見えているなら{" "}
              <Link
                href="/errors/403-forbidden"
        ...
        },
        {
          ...
          body: [
            "同じ access denied 系でも、403 は方針上の拒否や権限不足、429 は短時間アクセス過多やレート制限、確認ループは Cookie や JavaScript や IP 評価の不整合が中心です。見た目が似ていても次に疑う場所はかなり違います。",
            <>
              画面にコードがあるなら{" "}
              <Link
                href="/errors/403-forbidden"
        ...
        {
          type: "p",
          title: "特定サイトだけならサービス側の制御と切り分ける",
          body: [
            "1つのサイトやサービスだけ access denied になるなら、あなたの環境だけでなく、そのサービス側の地域制限、Bot 対策、ログイン基盤、部分障害が混ざって見えていることがあります。特にログイン前後や支払い・投稿・生成など一部機能だけで起きるときはこの傾向が強いです。",
            <>
              その場合は{" "}
              <Link
                href="/troubleshooting/specific-site-not-working"
        ...
        },
        {
          ...
          title: "判断のコツ",
          body: [
            "access denied は broad な症状名です。コードがあるか、確認ループなのか、回線差があるか、特定サイトだけかで分けると、次に見るべきページがかなり明確になります。",
          ],
        },
      ]}
    />

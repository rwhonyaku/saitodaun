  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "重要なのは『ネット全体が遅い』のか『そのサイトだけ遅い』のかを最初に分けることです。特定サイトだけ遅いなら、Wi-Fi や ISP 全体より、サイト固有の症状として整理したほうが見分けやすくなります。",
      ]}
      sections={[
        {
          type: "list",
        ...
        },
        {
          ...
          body: [
            "トップページは見えるのに、検索結果、会員ページ、購入処理、投稿画面など特定の操作だけ重いなら、回線速度よりその機能の裏側が遅れている可能性が高いです。見た目は『遅い』でも、実際には特定の API や認証、在庫確認し、保存処理だけが詰まっていることがあります。",
            <>
              その見え方なら{" "}
              <Link
                href="/troubleshooting/specific-site-not-working"

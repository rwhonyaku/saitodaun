...
export const metadata: Metadata = {
  ...
  description:
    "インターネットにつながらないときの原因と対処法を解説します。回線障害、Wi-Fi、DNS、ルーター、端末設定などを順番に切り分ける方法を紹介します。",
  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "重要なのは、ネット全体の問題なのか、自分の環境の問題なのかを順番に切り分けることです。慌てて設定を変える前に、まず状況を整理すると原因が見えやすくなります。",

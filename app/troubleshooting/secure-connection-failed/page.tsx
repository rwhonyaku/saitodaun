...
export const metadata: Metadata = {
  title: "「安全な接続ができません」と出るときの確認",
  description:
    "「安全な接続ができません」と出るときの確認ページです。証明書警告、SSLハンドシェイク失敗、SSLプロトコルエラー、端末時刻ずれ、回線や社内ネットワークの干渉など、次に見るべき既存ページへ案内します。",
  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "このページは、そうした SSL/HTTPS 症状を最短で確認するための橋渡しページです。証明書警告寄りなのか、ハンドシェイク失敗なのか、プロトコルエラーなのか、端末差や回線差があるのかを分けて、必要な既存ページへ進んでください。",
      ]}
      sections={[
        {
          type: "list",
          ...
          items: [
            ...
            "ハンドシェイク失敗やプロトコルエラーなら、TLS 設定不整合に近い",
        ...
        {
          type: "p",
          title: "安全な接続ができない表示は『サイトダウン』とは限らない",
          body: [
        ...
        {
          type: "p",
          title: "警告寄りなのか、SSLハンドシェイク失敗なのかで見る場所が違う",
          body: [
            "『この接続ではプライバシーが保護されません』のような警告は、証明書名不一致や期限切れ、信頼できない証明書などに近いです。一方で SSL ハンドシェイク失敗やプロトコルエラーは、TLS のやり取り自体が成立していないケースに寄ります。",
            <>
              警告寄りなら{" "}
              <Link
                href="/errors/your-connection-is-not-private"
        ...
        },
        {
          ...
          body: [
            "会社や学校の回線、VPN、公共 Wi-Fi でだけ安全な接続に失敗するなら、サイト設定だけでなく、途中のプロキシや SSL インスペクション、ネットワーク制限が影響している可能性があります。これは証明書の見え方が回線条件で変わるパターンです。",
            <>
              その場合は{" "}
              <Link
                href="/troubleshooting/site-blocked-by-firewall"
        ...
        },
        {
          ...
          body: [
            "複数端末、複数回線、複数ブラウザで同じ SSL 系エラーが出るなら、ローカル要因よりサイト側の証明書期限、証明書名不一致、TLS 設定不整合、CDN とオリジンサーバーの設定ずれに近いです。ユーザー側でできることは限られるため、原因の種類を見極めるのが重要です。",
            <>
              近い詳細ページとして{" "}
              <Link
                href="/errors/net-err-cert-common-name-invalid"

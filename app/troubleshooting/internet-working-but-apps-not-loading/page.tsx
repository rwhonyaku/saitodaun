...
export const metadata: Metadata = {
  ...
  description:
    "ブラウザは使えるのにアプリだけ開かないときの原因と対処法を解説します。サービス側の障害、アプリ固有の不具合、DNSやVPN、通信制限の見分け方をまとめています。",
  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "この場合、回線全体の障害ではなく、アプリ固有の不具合、サービス側の部分障害、DNS や VPN、端末側の通信制限などを疑ったほうが自然です。『ネットは生きている』ことが分かっているぶん、確認はしやすくなります。",
      ]}
      sections={[
        {
          type: "list",

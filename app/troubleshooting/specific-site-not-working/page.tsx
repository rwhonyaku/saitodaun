...
export const metadata: Metadata = {
  title: "特定のサイトだけ開かない原因と対処法｜DNS・制限・障害の切り分け",
  description:
    "他のサイトは見れるのに特定のサイトだけ開かない時に、サイト側障害、DNS、ブラウザ、回線制限、VPNやセキュリティ設定を順番に切り分けます。",
  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "大切なのは、いきなり原因を決めつけず、サイト側の問題なのか、自分の環境の問題なのかを順番に確認することです。このページでは、特定のサイトだけ開かないときの原因と確認の進め方を実用的に整理しています。",
      ]}
      sections={[
        {
          type: "list",
          title: "このページを使う状況",
          items: [
            "Googleや他のサイトは開くのに、対象サイトだけ開かない",
            "同じURLが別回線・別端末では開くかどうかを比べたい",
            "DNS、アクセス制限、ブラウザ保存データ、サイト側障害のどれに近いか判断したい",
            "トップページは開くが、ログインや決済など一部機能だけ失敗する理由を整理したい",
          ],
        },
        {
          type: "list",
        ...
        },
        {
          ...
          items: [
            ...
            "「SSL / 証明書の警告」なら、サイト側の証明書失効・中間証明書不備、または端末の時刻ずれや古いブラウザを確認すると見分けやすくなります。",
          ],
        },
        {
          type: "p",
          ...
          body: [
            ...
            "接続チェックでオンラインでも、ログイン後の画面、アプリ内API、アカウント制限、決済処理までは外部から判定できません。そこは症状の出る操作と公式案内を合わせて確認してください。",
          ],
        },
        {
          type: "div",
          title: "関連するエラーを先に読むと確認しやすいケース",
          body: [
            <>
              403や429なら{" "}
        ...
        },
        {
          ...
          body: [
            ...
            "最初にサイト側の障害かどうかを見て、その後に端末、ブラウザ、回線、DNSの順で確認すると、無駄なく原因に近づけます。",
            <>
              迷ったときは、まず{" "}
              <Link href="/" className="underline hover:no-underline">
                接続チェックツール

...
export const metadata: Metadata = {
  ...
  description:
    "サイトが本当にダウンしているのか、自分の回線や端末だけの問題なのかを確認する方法を解説します。確認の基本手順を分かりやすく紹介します。",
  ...
  return (
    <EvergreenPageShell
      ...
      lead={[
        ...
        "ここを最初に確認られるかどうかで、その後の対応がかなり変わります。サイト側の障害なら待つしかないこともありますが、自分の回線や端末の問題なら対処できる可能性があります。",
      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            "最初の確認ができるだけで、待つべきか、自分で直せるかの判断がかなりしやすくなります。",
          ],
        },
      ]}

      ...
      sections={[
        {
          ...
          title: "まず他の回線で試してみる",
          body: [
            "もっとも簡単な切り分けは、別の回線で同じサイトを開いてみることです。会社の Wi-Fi では開かないのにスマホのモバイル通信では開くなら、そのネットワーク側の制限が疑われます。",
        ...
        },
        {
          ...
          body: [
            ...
            "一時的に VPN やセキュリティ機能をオフにすると、原因の切り分けがしやすくなります。",
          ],
        },
        {
          type: "p",
        ...
        },
        {
          ...
          body: [
            "会社、学校、ISP、地域制限の可能性が高く、別回線で症状が変わるなら VPN で経路を変えて比較するとネットワーク依存かを確認しやすくなります。まずは切り分け目的で使い、サイト側障害の代わりと考えないのが大切です。",
            <>

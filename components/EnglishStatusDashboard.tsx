...
export default function EnglishStatusDashboard() {
  ...
  return <>
    <section className="relative overflow-hidden bg-slate-950 px-4 py-8 text-white sm:py-10">
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <ul className="mt-5 flex flex-wrap gap-2 text-xs font-semibold text-slate-200" aria-label="Evidence available on this page">
          ...
          <li className="rounded-full border border-white/10 bg-white/[0.06] px-3 py-1.5">Official &amp; independent sources</li>
        </ul>
      </div>
    </section>
    ...
    <section className="mx-auto w-full max-w-5xl px-4 py-8" aria-labelledby="live-status-heading">
      ...
      <h2 className="mt-8 text-xl font-bold text-slate-950">Major services</h2><p className="mt-1 text-xs leading-5 text-slate-500">Sparklines show recent user-report activity from Japan. Use an official source to see what the service owner has acknowledged; use Downdetector Japan to compare our regional signal with a separate reporting source.</p>
      ...
      <div className="mt-5 rounded-xl border border-slate-200 bg-slate-100 px-4 py-3 text-xs leading-5 text-slate-600"><b>How to compare:</b> agreement between our Japan reports, Downdetector Japan, and an official incident notice makes a broader problem more likely. A difference does not prove either source is wrong: regional, account-specific, and newly developing problems may appear at different times. External data is not reproduced here.</div>
    </section>
